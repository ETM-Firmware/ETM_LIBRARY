...
unsigned int ETMReadPinLatch(unsigned long pin);
/*
  This function will return zero if the pin's latch is not set.
  It will return non-zero if the pin's latch is set.
*/
